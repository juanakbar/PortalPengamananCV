...
define(['./RangeCoder','./Util'], function(RangeCoder,Util) {
  ...
  PPM.compressFile = Util.compressFileHelper(function(inStream, outStream, fileSize, props, finalByte) {
  ...
  PPM.decompressFile = Util.decompressFileHelper(function(inStream, outStream, fileSize) {
